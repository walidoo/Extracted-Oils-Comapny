                ...
                <div class="container">
                    ...
                    <div class="row sub_content">
                        <div class="col-lg-8 col-md-8 col-sm-8">
                            ...
                            <form id="" method="POST" action="./lib/enter_order.php" novalidate="novalidate">
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        <div class="col-lg-6 ">
                                            <input type="text" id="phone" name="phone" class="form-control" maxlength="100" data-msg-required="Your Phone Number." value="" placeholder="Your Phone Number" >
                                        </div>
                                        <div class="col-lg-6">                                       
                                            <select class="form-control products_name" name="products_name" id="sel1">
